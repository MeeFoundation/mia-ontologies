...
created: 2026-07-10
description: >
  Cell DataBook of category "Passport" (cell:origin: cat:Passport). Content may include topics/folder/note links, and may carry one or two required subject values.
mia:
  origin: "cat:Passport"
  creator: ":Self"
