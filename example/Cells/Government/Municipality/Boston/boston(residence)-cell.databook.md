---
id: http://www.example.org/mia/categories/boston(residence)-cell
title: "Boston (Cell)"
type: cell-databook
version: 1.1.0
created: 2026-07-10
description: >
  Cell DataBook of category "Boston" (mia.catType: Residence). Content may include topics/folder/note links, and may carry one or two required subject values.
mia:
  creator: ":Self"
  memberCount: "cell:OneMember"
  subject: ":Self"
  memberTopics: "https://www.example.org/mia/topics/self.self(boston)(residence)(13)"
  topics:
    - id: "https://www.example.org/mia/topics/self.self(boston)(residence)(13)"
...
<a id="topic-13"></a>
### Topic 13 — About Alice Walker in the Municipality cell as claimed by Alice Walker
...
<!-- databook:graph: https://www.example.org/mia/topics/self.self(boston)(residence)(13)#graph -->
