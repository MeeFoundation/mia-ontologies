...
created: 2026-07-10
description: >
  Cell DataBook of category "Bob Johnson" (cell:origin: cat:Others). Content may include topics/folder/note links, and may carry one or two required subject values.
mia:
  origin: "cat:Others"
  creator: ":Self"
