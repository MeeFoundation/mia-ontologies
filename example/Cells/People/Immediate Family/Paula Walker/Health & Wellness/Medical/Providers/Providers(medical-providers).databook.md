...
created: 2026-07-10
description: >
  Cell DataBook for folder "Providers" (cell:origin: cat:MedicalProviders). It is a
  one-member cell with one memberTopic about :Self — a minimal stub,
  since "Providers" is a purely organizational category node with no
