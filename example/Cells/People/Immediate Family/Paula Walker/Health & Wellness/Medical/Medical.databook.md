...
created: 2026-07-10
description: >
  Cell DataBook for folder "Medical" (cell:origin: cat:Medical). It is a
...
mia:
  ...
  memberTopics: "topic-49"
  topics:
    - id: "http://www.example.org/mia/topics/topic-49"
      claimant: ":Self"
      subject: ":Self"
      shapes:
