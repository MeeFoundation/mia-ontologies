...
title: "About Alice Walker in the Alice Walker category as asserted by Alice Walker"
...
mia:
  category: "http://www.example.org/mia/categories/alice-walker(acme)"
  assertedBy: ":Self"
  subject: ":Self"
  about-by: "context:SBScontext"
  template: "persona:JSContactCard"
graph:
  named_graph: https://www.example.org/mia/contexts/self.self(alice-walker)(acme)(10)#graph
  rdf_version: "1.1"
shapes:
...
<!-- databook:graph: https://www.example.org/mia/contexts/self.self(alice-walker)(acme)(10)#graph -->
