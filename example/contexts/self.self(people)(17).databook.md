---
id: http://www.example.org/mia/self.self(people)(17)
...
graph:
  named_graph: http://www.example.org/mia/self.self(people)(17)#graph
  rdf_version: "1.1"
shapes:
...
<!-- databook:graph: http://www.example.org/mia/self.self(people)(17)#graph -->
