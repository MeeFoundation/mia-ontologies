---
id: http://www.example.org/mia/self.self(california-dmv)(22)
...
graph:
  named_graph: http://www.example.org/mia/self.self(california-dmv)(22)#graph
  rdf_version: "1.1"
shapes:
...
<!-- databook:graph: http://www.example.org/mia/self.self(california-dmv)(22)#graph -->
