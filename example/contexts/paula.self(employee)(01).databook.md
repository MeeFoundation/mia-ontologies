---
id: http://www.example.org/mia/paula.self(employee)(01)
...
graph:
  named_graph: http://www.example.org/mia/paula.self(employee)(01)#graph
  rdf_version: "1.1"
shapes:
...
<!-- databook:graph: http://www.example.org/mia/paula.self(employee)(01)#graph -->
