---
id: http://www.example.org/mia/self.self(family)(18)
...
graph:
  named_graph: http://www.example.org/mia/self.self(family)(18)#graph
  rdf_version: "1.1"
shapes:
...
<!-- databook:graph: http://www.example.org/mia/self.self(family)(18)#graph -->
