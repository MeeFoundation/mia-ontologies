---
id: http://www.example.org/mia/self.self(paula-walker)(employee)(20)
...
graph:
  named_graph: http://www.example.org/mia/self.self(paula-walker)(employee)(20)#graph
  rdf_version: "1.1"
shapes:
...
<!-- databook:graph: http://www.example.org/mia/self.self(paula-walker)(employee)(20)#graph -->
