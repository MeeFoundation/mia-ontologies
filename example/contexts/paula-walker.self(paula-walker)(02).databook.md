---
id: http://www.example.org/mia/paula-walker.self(paula-walker)(02)
...
graph:
  named_graph: http://www.example.org/mia/paula-walker.self(paula-walker)(02)#graph
  rdf_version: "1.1"
shapes:
...
<!-- databook:graph: http://www.example.org/mia/paula-walker.self(paula-walker)(02)#graph -->
