...
graph:
  named_graph: https://www.example.org/mia/contexts/self.bob-johnson(bob-johnson)(others)(08)#graph
  rdf_version: "1.1"
shapes:
...
<!-- databook:graph: https://www.example.org/mia/contexts/self.bob-johnson(bob-johnson)(others)(08)#graph -->
