---
id: http://www.example.org/mia/self.self(bob-johnson)(17)
...
graph:
  named_graph: http://www.example.org/mia/self.self(bob-johnson)(17)#graph
  rdf_version: "1.1"
shapes:
...
<!-- databook:graph: http://www.example.org/mia/self.self(bob-johnson)(17)#graph -->
