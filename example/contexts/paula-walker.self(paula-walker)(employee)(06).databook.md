---
id: https://www.example.org/mia/contexts/paula-walker.self(paula-walker)(employee)(06)
...
graph:
  named_graph: https://www.example.org/mia/contexts/paula-walker.self(paula-walker)(employee)(06)#graph
  rdf_version: "1.1"
shapes:
...
<!-- databook:graph: https://www.example.org/mia/contexts/paula-walker.self(paula-walker)(employee)(06)#graph -->
