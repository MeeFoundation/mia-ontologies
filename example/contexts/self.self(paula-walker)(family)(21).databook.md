---
id: http://www.example.org/mia/self.self(paula-walker)(family)(21)
...
graph:
  named_graph: http://www.example.org/mia/self.self(paula-walker)(family)(21)#graph
  rdf_version: "1.1"
shapes:
...
<!-- databook:graph: http://www.example.org/mia/self.self(paula-walker)(family)(21)#graph -->
