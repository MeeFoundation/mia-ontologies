---
id: https://www.example.org/mia/topics/self.self(ownership)(ownership)(22)
...
mia:
  ...
  subject: ":Self"
graph:
  named_graph: https://www.example.org/mia/topics/self.self(ownership)(ownership)(22)#graph
  rdf_version: "1.1"
shapes:
...
<!-- databook:graph: https://www.example.org/mia/topics/self.self(ownership)(ownership)(22)#graph -->
