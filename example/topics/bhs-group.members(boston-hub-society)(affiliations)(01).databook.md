...
description: >
  ...
  A g:Group topic claimable by any permitted member.
mia:
  claimant: ":BHS_Group"
  subject: ":BHS_Group"
graph:
  named_graph: https://www.example.org/mia/topics/bhs-group.members(boston-hub-society)(affiliations)(01)#graph
  rdf_version: "1.1"
shapes:
