...
| Ginger's Medications | Ginger | [Ginger.databook.md](<example/Cells/Pets/Ginger/Ginger.databook.md>) {41} | Ginger | `cat:Pets` | 36 |
...
| 36 | [Ginger.databook.md](<example/Cells/Pets/Ginger/Ginger.databook.md#topic-36>) {41} | `cat:Pets`     | Alice's bare given-name claim — the Ginger cell's required memberTopic          | [view](example/topics/images/topic-36.png) |
