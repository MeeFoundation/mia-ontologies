...
Ideally it would have filed the new cell from Alice under People / Immediate Family because she is Paula's daughter, but Paula's app didn't know that, so it did the best it could. To perfect things, Paula can create an Immediate Family cell under her People cell and move Alice (and all sub-cells) under it.
