...
| Graph 18 — `example/Cells/Home/Paradise/Paradise(residence).databook.md` | Alice's Paradise, CA address — current residence (2025–present) |
| Graph 13 — `example/Cells/Home/Previous/Boston/Boston(residence).databook.md` | Alice's Boston, MA address — previous residence (2020–2025) |
...
| Graph 36 — `example/Cells/Pets/Ginger/Ginger(pets).databook.md` | Deliberately empty — the `cat:Pets`-category Ginger cell's required `member` entry, claimed by Alice; `member`'s requirement is about `c:subject`/`c:claimant`, not content |
