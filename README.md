...
| 5  | [bob(colleague...)](example/bob-contexts/bob(bob)alice.(bob).ttl) | Colleagues | Personal notes Alice has made about her colleague Bob | [view](images/example/bob-contexts/bob(colleague-of-alice).png) |
| 6 | in progress...
