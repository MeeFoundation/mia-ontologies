...
A cell is a secure container of information that can remain private to the user or be shared with other users and with services — an AI agent, a cell backup service, or an organization's own service. It enables these members share context, communicate and collaborate towards a common purpose.
